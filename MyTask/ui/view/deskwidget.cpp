...
DeskWidget::DeskWidget(DeskModel *desk) {
    ...
    openButton->setStyleSheet(BUTTON_EMPTY);
    //openButton->setSizePolicy(QSizePolicy::Maximum, QSizePolicy::Minimum);
    buttonContainer->setContentsMargins(24,0,24,24);
    connect(openButton, &QPushButton::clicked, this, &DeskWidget::buttonPressed);
    buttonContainer->addWidget(openButton);
